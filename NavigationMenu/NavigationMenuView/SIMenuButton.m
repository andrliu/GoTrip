...
//        self.title.textColor = currentStyle[UITextAttributeTextColor];                //depricated
        self.title.textColor = currentStyle[NSForegroundColorAttributeName];
//        self.title.font = currentStyle[UITextAttributeFont];                          //depricated
        self.title.font = currentStyle[NSFontAttributeName];
//        self.title.shadowColor = currentStyle[UITextAttributeTextShadowColor];        //depricated
        self.title.shadowColor = currentStyle[NSShadowAttributeName];
//        NSValue *shadowOffset = currentStyle[UITextAttributeTextShadowOffset];        //depricated
